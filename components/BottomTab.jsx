...
const BottomTab = ({activeScreen}) => {
  ...
  return (
    <View className="absolute bottom-6 w-full px-8">
     <View className="bg-[#130d2d] rounded-xl px-4 py-6 w-full flex-row justify-around">
      <TouchableOpacity>
      ...
      <TouchableOpacity>
        <MaterialIcons name='collections' size={32}  color={activeScreen === "ProductScreen" ? "#fff" : "#5c5576"} />
      </TouchableOpacity>
